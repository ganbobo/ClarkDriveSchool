...
- (MXPullDownMenu *)initWithArray:(NSArray *)array selectedColor:(UIColor *)color
{
    ...
    if (self) {
        ...
        _menuColor = [UIColor colorWithRed:0x69/255.0 green:0x69/255.0 blue:0x69/255.0 alpha:1.0];
        ...
        for (int i = 0; i < _numOfMenu; i++) {
            ...
            CGPoint position = CGPointMake( (i * 2 + 0.9) * textLayerInterval, self.frame.size.height / 2);
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, self.height - 0.5, ScreenWidth, 0.5)];
