...
- (BOOL)searchDisplayController:(UISearchDisplayController *)controller shouldReloadTableForSearchString:(NSString *)searchString {
    ...
    _filterData =  [[NSArray alloc] initWithArray:[_dataSource filteredArrayUsingPredicate:predicate]];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    if (tableView == _tableView) {
        ...
        NSArray *list = dic.allValues.firstObject;
        return list.count;
    }else{
...
- (NSArray *)sectionIndexTitlesForTableView:(UITableView *)tableView {
    if ([_tableView isEqual:tableView]) {
        ...
        for (NSDictionary *dic in _dataSource) {
            [titleArray addObject:dic.allKeys.firstObject];
        }
        return titleArray;
    }
